...
const Home = () => {
  return (
    <section className='w-full font-poppins bg-[#FFFAF3]'>
            ...
            <div className='md:max-w-7xl mx-auto md:px-0 px-5 py-20 '>
              <div className='flex flex-col md:flex-row gap-10 bg-[#27AAFF] px-5 pt-10 md:px-10 rounded-3xl items-center justify-center '>
                ...
                <div className='flex flex-col'>
                  ...
                  <div className='flex flex-col md:max-w-[300px] text-center items-center justify-center gap-4'>
                   <img src={heroicon1} alt='ability' className='w-7 h-9 object-cover' />
                     <h2 className='text-ssm font-semibold mt-2'>400+ hours program</h2>
                         </div>
                     {/* 2 */}
                       ...
                       <h2 className='text-ssm font-semibold mt-2'>Strong Portfolio</h2>
                       </div>
                          {/* 3 */}
                         <div className='flex flex-col md:max-w-[200px] text-center items-center justify-center gap-4 mt-'>
                          <img src={heroicon3} alt='ability' className='w-8 h-8 object-cover' />
                            <h2 className='text-ssm font-semibold mt-2'>Career Mentorship</h2>
                           </div>
                ...
                <div className='flex-1 md:max-w-[500px] items-center justify-center '>
                     <img src={heroimg} alt='image' className='w-full h-auto object-cover' />
        ...
        <section className='md:max-w-5xl mx-auto md:px-0 px-5 pt-10'>
              <div className='bg-white rounded-2xl '>
                    <div className='flex flex-col md:flex-row md:gap-30 gap-10 md:px-16 md:py-25 p-6 items-center'>
                        {/* left side */}
                        <div className='md:max-w-[400px]'>
                              <h2 className='md:text-3xl text-2xl font-semibold font-poppins'>
                                Zeplus, the leading education technology start-up and training provider in Africa and soon to the world
                              </h2>
                        </div>
                        {/* right side */}
       ...
       <div className='md:max-w-7xl mx-auto md:px-0 px-5 py-20 '>
                 <div className='text-center items-center justify-center mx-auto py-'>
                          <div className='flex flex-row gap-3 justify-center mb-2'>
                             <h2 className='text-[1.5rem] font-[550] tracking-tight md:text-[3rem] font-poppins'>Boost your </h2>
                             <span>
                              <img src={figma} alt='' className='w-8 h-7 mt-7' />
                             </span>
                             <h2 className='text-[1.5rem] font-[550] tracking-tight md:text-[3rem] font-poppins'>tech skills</h2>
                          </div>
                          <div className='flex flex-row gap-3 justify-center mb-3'>
                             <h2 className='text-[1.5rem] font-[550] tracking-tight md:text-[3rem] font-poppins'>Build Your </h2>
                             <span>
                              <img src={reactimg} alt='' className='w-8 h-7 mt-6' />
                             </span>
                             <h2 className='text-[1.5rem] font-[550] tracking-tight md:text-[3rem] font-poppins'>Career And Portfolio</h2>
                          </div>
                          {/* Courses */}
                    <div className=' mx-auto text-center items-center justify-center'>
                      <div className='grid grid-cols-2 md:grid-cols-6 gap-6 md:gap-10 mt-10 justify-center font-poppins'>
                              ...
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>Cybersecurity</h2>
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>UI/UX Design</h2>
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>Web Development</h2>
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>Data Analysis</h2>
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>AI Prompting</h2>
                              <h2 className='border border-black rounded-full py-2 px-4 text-sm font-semibold'>Graphic Design</h2>
   ...
   {/* How it works section */}
      <section className='relative mb-36 flex w-full flex-col items-center justify-center px-container-base lg:px-container-lg xl:px-container-xl'>
      <div className='sticky top-[35vh] text-center'>
        <div className='opacity-90 flex-col flex gap-3 mt-10'>
          <div>
            <h2 className='items-center justify-center text-[4rem] font-[700] tracking-tight md:text-[5rem] font-poppins'>Why Zeplus Academy</h2>
          </div>
            <h2 className='items-center justify-center text-[5rem] font-[700] tracking-tight md:text-[6rem] font-poppins'>How It works</h2>
        </div>
  ...
  <div className='flex min-h-[400px] max-w-sm flex-col justify-between rounded-[20px] bg-[#74E9DB] p-5 ' style={{ opacity: 1, transform: 'rotate(-15deg)' }}>
         ...
         <p className='text-[1.7em] font-[700] tracking-tight md:text-[2.2em]'>We don't just teach tech — we prepare Africa's youth to lead innovation.</p>
        </div>
      ...
      <div className='sticky top-[25vh] flex w-full justify-center'>
        <div className='flex min-h-[400px] max-w-sm flex-col justify-between rounded-[20px] bg-[#BAE3F4] p-5 ' style={{ opacity: 1, transform: 'rotate(-10deg)' }}>
         ...
         <p className='text-[1.7em] font-[700] tracking-tight md:text-[2.2em]'>Fill the Application form</p>
        </div>
      ...
      <div className='sticky top-[25vh] flex w-full justify-center'>
        ...
        ' style={{ opacity: 1, transform: 'rotate(-5deg)' }}>
         ...
         <p className='text-[1.7em] font-[700] tracking-tight md:text-[2.2em]'>Select the track you want to learn</p>
        </div>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-6  '>
                        ...
                        <div className='bg-white  px-6 py-4 rounded-xl'>
                              <div className='flex flex-col max-w-[200px] '>
                                  ...
                                  <h2 className='text-4xl font-bold font-poppins'>Master the Essentials </h2>
                        ...
                        <div className='bg-white px-6 py-4 rounded-xl'>
                              <div className='flex flex-col max-w-[200px] '>
                                  ...
                                  <h2 className='text-4xl font-bold font-poppins'>Build your Tech Skills </h2>
                        ...
                        <div className='bg-white  px-6 py-4 rounded-xl'>
                              <div className='flex flex-col max-w-[200px] '>
                                  ...
                                  <h2 className='text-4xl font-bold font-poppins'>Become a Tech Pro </h2>
                    ...
                    <div className='md:max-w-7xl mx-auto md:px-0 px-5 py-7  bg-[#EEE8DF] rounded-2xl my-15'>
                                  ...
                                  {/* left side */}
                                       <div className='flex-1 flex-col md:max-w-[800px]'>
                                        ...
                                        <div className='flex-1 md:max-w-[400px] items-center justify-center '>
                                             <img src={masterimg} alt='image' className='w-full h-70 object-cover' />
                                        </div>
                                 </div>
                             </div>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-6  '>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                ...
                                <h2 className='text-2xl font-bold'>Social Media Marketing Essentials</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Python Essentials</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Web Development Essentials</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        {/*  Boost your tech career */}
                          <div className='md:max-w-7xl mx-auto md:px-0 px-5 py-7  bg-[#EEE8DF] rounded-2xl mt-15'>
                             <div className='px-10 py-10 bg-[#E60B14] rounded-2xl max-w-[1300px] mx-auto'>
                                 <div className='flex flex-col text-center items-center justify-center text-white'>
                                                  ...
                                                  {/* abilities */}
                                                  <div className='flex flex-row gap-8 mt-5'>
                                                    <div className='flex flex-col md:max-w-[150px] text-center items-center justify-center gap-4'>
                                                      <img src={ability1} alt='ability' className='w-6 h-6 object-cover' />
                                                      <h2 className='text-sm font-light mt-2'>Up-to-date skillset</h2>
                                                    </div>
                                                    {/* 2 */}
                                                    <div className='flex flex-col md:max-w-[150px] text-center items-center justify-center gap-4 mt-5'>
                                                    ...
                                                    {/* 3 */}
                                                    <div className='flex flex-col md:max-w-[150px] text-center items-center justify-center gap-4 mt-7'>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-4 gap-6  '>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Cybersecurity - CompTIA Security+ Certified</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Graphic Design - Adobe Certified</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        <div className='bg-white py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Performance Marketing - Meta Certified</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
                        ...
                        <div className='bg-white  py-10 px-6 rounded-2xl'>
                          <div className='flex flex-col gap-4 max-w-[200px]'>
                                <img src={icondetail} alt='icon' className='w-8 h-6 object-cover ' />
                                <h2 className='text-2xl font-bold'>Data Analytics - Microsoft Power BI Certified</h2>
                                {/* Course Link */}
                                <div className='flex flex-row gap-2 mt-2'>
                                    <p className='underline cursor pointer font-semibold text-xl'>Course Details</p>
                                    <span>
             ...
             {/* Alumni Section */}
                 <div className='w-full bg-[#FFFAF3]'>
                     ...
                     <div className='flex flex-col bg-[#FFFFFF] p-6 rounded-2xl'>
                         <div>
                          <h2 className='text-2xl font-sora font-semibold mb-2'>“The program is rewarding, very beneficial, and has clear and precise chapters.”</h2>
                          <p className='text-ssm font-[400] mb-4'>“The experience at GOMYCODE is super interesting, you learn so many game-changing techniques and 
                         ...
                         <div className='flex flex-row gap-8 mt-8'>
                          ...
                          <h2 className='text-xl font-sora font-semibold mt-4 font-sora'>MAYA</h2>
                         </div>
                     </div>
                      {/* Alumni 2 */}
                      <div className='flex flex-col bg-[#FFFFFF] p-6 rounded-2xl'>
                         <div>
                          <h2 className='text-2xl font-sora font-semibold mb-2'>“I have landed many freelance contracts after my training.”</h2>
                          <p className='text-ssm font-[400] mb-4'>“I have succeded in landing many freelance contracts after my training at GOMYCODE. I am even able to lead projects with new technologies thanks to my ability
                             to be an autonomous learner.”</p>
                         </div>
                         <div className='flex flex-row gap-8 mt-8'>
                          <img src={alumni2} alt='alumni' className='w-16 h-16 rounded-full' />
                          <h2 className='text-xl font-sora font-semibold mt-4 font-sora'>ANOUAR</h2>
                         </div>
                     </div>
                      {/* Alumni 3 */}
                      <div className='flex flex-col bg-[#FFFFFF] p-6 rounded-2xl'>
                         <div>
                          <h2 className='text-2xl font-sora font-semibold mb-2'>“The training helped me strengthen my skills and boost my clothing sales project.”</h2>
                          <p className='text-ssm font-[400] mb-4'>“The training helped me strengthen my digital marketing skills and give a new impetus to my clothing sales project. Our instructor is very motivating, and understanding,
                         ...
                         <div className='flex flex-row gap-8 mt-8'>
                          ...
                          <h2 className='text-xl font-sora font-semibold mt-4 font-sora'>SELIM</h2>
                         </div>
                     </div>
                      {/* Alumni 4 */}
                      <div className='flex flex-col bg-[#FFFFFF] p-6 rounded-2xl'>
                         <div>
                          <h2 className='text-2xl font-sora font-semibold mb-2'>“I have created my startup thanks to what I learned during my training”</h2>
                          <p className='text-ssm font-[400] mb-4'>“I have been able to create a successful online platform called Boky.tn, and I have obtained the startup 
                         ...
                         <div className='flex flex-row gap-8 mt-8'>
                          ...
                          <h2 className='text-xl font-sora font-semibold mt-4 font-sora'>RAZAK</h2>
                         </div>
                     </div>
                     </div>
                  </div>
